...
export const InbuiltAgentMetricKind = z.enum(["bytes_in", "bytes_out", "duration_ms", "records_in", "records_out"]);
export const CustomAgentMetricKind = z.string().regex(/^[a-zA-Z][a-zA-Z0-9_.-]{0,63}$/);
