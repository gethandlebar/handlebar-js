...
export type RunStartedEvent = AuditEnvelope<"run.started", {
...
export type ToolDecisionEvent = AuditEnvelope<"tool.decision", {
...
export type ToolResultEvent = AuditEnvelope<"tool.result", {
  tool: { name: string; categories?: string[] };
...
export type RunEndedEvent = AuditEnvelope<"run.ended", {
...
export type ErrorEvent = AuditEnvelope<"error", {
