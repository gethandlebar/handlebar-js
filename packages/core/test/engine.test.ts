...
describe("Rule evals - enduser rule", () => {
  ...
  it.each(["1", "5", "avalue", "true", "True", "false"])("Should eval true for 'has' op if tag value is truthy", (value: string) => {
    const engine = new GovernanceEngine({
      tools: [],
      defaultUncategorised: "allow",
    });
  ...
  it.each([""])("Should eval false for 'has' op if tag value is falsy", (value: string) => {
    const engine = new GovernanceEngine({
      tools: [],
      defaultUncategorised: "allow",
    });
  ...
  it.each(["somevalue", "any", "!", "false"])("Should eval true for 'hasValue' op if tag value matches expected exactly", (value: string) => {
    const engine = new GovernanceEngine({
      tools: [],
      defaultUncategorised: "allow",
    });
  ...
  it.each(["", "!", "_", "!avalue", " avalue"])("Should eval false for 'hasValue' op if values don't match", (actualValue: string) => {
    const engine = new GovernanceEngine({
      tools: [],
      defaultUncategorised: "allow",
    });
